        ...
        <div class="col-md-12 mx-auto pt-5">
            <div class="card col-lg-10 col-md-6 col-sm-12 mx-auto my-5">
                <div class="card-header bg-info">
                    <h3 class="text-white">Register as a Seller Account</h3>
                </div>
                            ...
                            <form action="{{route('buyer.register')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email_address" value="{{old('email_address')}}"
                                                   class="form-control" id="username" placeholder="Email Address">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="phone_no" minlength="11" maxlength="11"
                                                       value="{{old('phone_no')}}" class="form-control" id="username"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="zip" value="{{old('zip')}}" class="form-control"
                                                   id="last_name" placeholder="Zip or Postal Code">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="password" name="password" class="form-control" id="first_name"
